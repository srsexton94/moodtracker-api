...
RSpec.describe NeedsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new need" do

        post :create, params: {need: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(need_url(Need.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new need" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the need" do
        need = Need.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the need" do
        need = Need.create! valid_attributes
